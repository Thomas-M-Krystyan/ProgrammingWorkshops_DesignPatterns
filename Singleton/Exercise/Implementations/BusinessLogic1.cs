...
namespace Singleton.Exercise.Implementations
{
    ...
    {
        private readonly HttpClient _httpClient = new();  // NOTE: New C# 9.0 syntax, to not write obvious "new HttpClient()" => https://docs.microsoft.com/en-us/dotnet/csharp/whats-new/csharp-9
